...
namespace Repository.Repositories
{
	...
	/// for DataSourceConfig-specific data access operations.
	/// </remarks>
	/// <param name="avmContext">
	/// The AVM database context used to access persistence data.
	/// </param>
	public class DataSourceConfigRepository(NotificationContext notificationContext)
		: RepositoryBase<DataSourceConfig>(notificationContext), IDataSourceConfigRepository
	{
	}
}
